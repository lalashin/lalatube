...
const Header = () => {
  return (
    <header id='header' role='banner'>
      ...
      <ul>
        <li>
            <a href='https://github.com/lalashin' rel='noopener noreferrer'>
                <AiFillGithub />
            </a>
        </li>
        <li>
            <a href='https://blog.naver.com/ppeanut' rel='noopener noreferrer'>
            <AiFillMessage />
            </a>
        </li>
        <li>
            <a href='https://codepen.io/lalashin' rel='noopener noreferrer'>
                <AiOutlineCodepen />
            </a>
        </li>
        <li>
            <a href='https://front-end-developer-lala.netlify.app/' rel='noopener noreferrer'>
                <AiFillHome />
            </a>
        </li>
    </ul>
